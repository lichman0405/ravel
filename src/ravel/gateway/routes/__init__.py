...
shares, `control` is the owner's, `lab` is the lab user's, and `admin` is the
administrator's. A route that does not obviously belong to one of those is a
route whose authority has not been decided.
"""
